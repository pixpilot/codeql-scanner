...
describe('patternMatcher', () => {
  describe('matchesPattern', () => {
    ...
    it('should handle specific CodeQL config patterns', () => {
      // Test patterns from the user's config
      expect(
        PatternMatcher.matchesPattern('src/utils/helper.test.ts', '**/*.test.ts'),
      ).toBe(true);
      expect(
        PatternMatcher.matchesPattern(
          'actions/codeql-scanner /test/utils/pattern-matcher.test.ts',
          '**/*.test.ts',
        ),
      ).toBe(true);
      expect(
        PatternMatcher.matchesPattern(
          'actions/codeql-scanner /test/utils/logger.test.ts',
          '**/test/**/*',
        ),
      ).toBe(true);
      expect(
      ...
      expect(PatternMatcher.matchesPattern('src/main.js', '**/*.test.ts')).toBe(false);
      expect(PatternMatcher.matchesPattern('src/main.js', '**/test/**/*')).toBe(false);
      expect(
        PatternMatcher.matchesPattern('src/utils/formatter.js', '**/node_modules/**/*'),
      ).toBe(false);
    });
